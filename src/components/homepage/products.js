...
const Products = () => {
    ...
    return (
        <div className={"relative h-[100vh]"}>
            ...
            <div className={"w-full max-w-[1200px] m-auto px-2 my-7 max-md:my-1 max-md:text-[14px]"}>
                <div className={"flex flex-wrap justify-start border-b-2 py-2 max-md:justify-center"}>
                    ...
                    <button onClick={handleDescending}
                            className={"te=>xt-[16px]leading-[19px] mx-8 max-md:mx-2 font-[500] focus:text-purple-700"}>Ascending<NorthIcon
                ...
                <div className={"flex flex-wrap justify-between  max-md:flex-nowrap overflow-x-auto "}>
                    {filter.length > 0 ?
                        filter.map((product) => {
