        ...
        <>
            <Link to={`/product/${product.id}`}>
                <div onClick={handleOpen}
                     className={"flex-col w-[264px] h-[410px] max-md:w-[150px] max-md:h-[265px] transition ease-in-out delay-200 hover:scale-105 p-3 max-md:p-1.5 shadow-lg m-1.5 rounded-[10px] items-center relative"}>
